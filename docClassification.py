...
def get_data():
    ...
    train_target = trainClasses
    train_target_names = [ ('C-'+str(i)) for i in range(1,11)]

    test_data = testSet
    test_target =testClasses
    test_target_names = [ ('C-'+str(i)) for i in range(1,11)]
...
def benchmark(clf):
    ...
    if hasattr(clf, 'coef_'):
        ...
        if True or opts.print_top10 and feature_names is not None:
